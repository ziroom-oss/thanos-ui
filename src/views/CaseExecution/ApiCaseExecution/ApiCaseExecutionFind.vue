  ...
  <div class="test-case-search">
    <el-form :model="testCaseForm" ref="testCaseForm" label-width="100px" class="test-testCaseForm">
      <el-row :gutter="24">
        ...
        <el-col :span="6">
          <el-form-item label="用户姓名:" prop="createUser">
            <el-select
...
import {queryCaseExecution, getTestExecutionMap, getEhrUserDetailLikeUserName} from '@/api/model/caseExecution'
export default {
  name: 'ApiCaseExecutionFind',
  computed: {
    cascaderConfig () {
      return {
